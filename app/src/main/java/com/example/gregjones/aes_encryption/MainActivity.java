package com.example.gregjones.aes_encryption;
            ...
            bt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        TextView tv_display = (TextView) findViewById(R.id.textView_Encrypted);
             ...
             Button bt_decrypt = (Button) findViewById(R.id.button2);
             bt_decrypt.setOnClickListener(new View.OnClickListener() {
                 @Override
                 public void onClick(View v) {
                     try {
                         TextView tv_encrypted = (TextView) findViewById(R.id.textView_Encrypted);
                         String encryptedData = tv_encrypted.getText().toString();
                         String decryptedtext = decrypt(key, encryptedData);
                         TextView tv_display = (TextView) findViewById(R.id.textView_decrypted);
